...
source_dir="/staging/groups/clarivate_data/2026-complete-extract/JSON"
...
python3 match_affiliations.py $input_file $cluster_id $process_id

staging_storage_dir="/staging/<USERNAME>/wosaffiliation-matches"
